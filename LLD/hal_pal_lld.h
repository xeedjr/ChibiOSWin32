 ...
 * @brief	SIMUL/MEGA PAL subsystem low level driver header.
 *
 * @addtogroup PAL
 * @{
 */
 ...
 */
typedef volatile SIMUL_gpio_registers_t * ioportid_t;
 ...
 */
#define IOPORT1     ((SIMUL_gpio_registers_t *)&SIMUL_port1)

/**
 * @brief   GPIO port B identifier.
 */
#define IOPORT2     ((SIMUL_gpio_registers_t *)&SIMUL_port2)

/**
 * @brief   GPIO port C identifier.
 */
#define IOPORT3     ((SIMUL_gpio_registers_t *)&SIMUL_port3)

/**
 * @brief   GPIO port D identifier.
 */
#define IOPORT4     ((SIMUL_gpio_registers_t *)&SIMUL_port4)

/**
 * @brief   GPIO port E identifier.
 */
#define IOPORT5     ((SIMUL_gpio_registers_t *)&SIMUL_port5)

/**
 * @brief   GPIO port F identifier.
 */
#define IOPORT6     ((SIMUL_gpio_registers_t *)&SIMUL_port6)

/**
 * @brief   GPIO port G identifier.
 */
#define IOPORT7     ((SIMUL_gpio_registers_t *)&SIMUL_port7)

/**
 * @brief   GPIO port H identifier.
 */
#define IOPORT8     ((SIMUL_gpio_registers_t *)&SIMUL_port8)

#if defined(PORTJ) || defined(__DOXYGEN__)
/**
 * @brief   GPIO port J identifier.
 */
#define IOPORT9     ((volatile SIMUL_gpio_registers_t *)&PINJ)
#endif
 ...
 */
#define IOPORT10    ((volatile SIMUL_gpio_registers_t *)&PINK)
#endif
 ...
 */
#define IOPORT11    ((volatile SIMUL_gpio_registers_t *)&PINL)
#endif
 ...
 */
#define IOPORTADC   ((volatile SIMUL_gpio_registers_t *)&PINADC)
#endif
 ...
 */
#define IOPORTSPI1  ((volatile SIMUL_gpio_registers_t *)&PIN_SPI1)
#endif
