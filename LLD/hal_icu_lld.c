 ...
 * @brief   SIMUL/MEGA ICU subsystem low level driver source.
 *
 * @addtogroup ICU
 * @{
 */
...
#if SIMUL_ICU_USE_TIM1
  icuObjectInit(&ICUD1);
#endif
#if SIMUL_ICU_USE_TIM3
  icuObjectInit(&ICUD3);
#endif
#if SIMUL_ICU_USE_TIM4
  icuObjectInit(&ICUD4);
#endif
#if SIMUL_ICU_USE_TIM5
  icuObjectInit(&ICUD5);
#endif
}
