 ...
 * @brief   SIMUL/MEGA I2C subsystem low level driver header.
 *
 * @addtogroup I2C
 * @{
 */
 ...
 */
#if !defined(SIMUL_I2C_USE_I2C1) || defined(__DOXYGEN__)
#define SIMUL_I2C_USE_I2C1           FALSE
#endif
/** @} */
