 ...
 * @brief   SIMUL/MEGA GPT subsystem low level driver header.
 *
 * @addtogroup GPT
 * @{
 */
 ...
 */
#if !defined(SIMUL_GPT_USE_TIM1)
#define SIMUL_GPT_USE_TIM1              FALSE
#endif
 ...
 * @note      The default is @p FALSE.
 */
#if !defined(SIMUL_GPT_USE_TIM2)
#define SIMUL_GPT_USE_TIM2              FALSE
#endif
 ...
 * @note      The default is @p FALSE.
 */
#if !defined(SIMUL_GPT_USE_TIM3)
#define SIMUL_GPT_USE_TIM3              FALSE
#endif
 ...
 * @note      The default is @p FALSE.
 */
#if !defined(SIMUL_GPT_USE_TIM4)
#define SIMUL_GPT_USE_TIM4              FALSE
#endif
 ...
 * @note      The default is @p FALSE.
 */
#if !defined(SIMUL_GPT_USE_TIM5)
#define SIMUL_GPT_USE_TIM5              FALSE
#endif
