 ...
 * @brief   SIMUL/MEGA ICU subsystem low level driver header.
 *
 * @addtogroup ICU
 * @{
 */
 ...
 */
#if !defined(SIMUL_ICU_USE_TIM1) || defined(__DOXYGEN__)
#define SIMUL_ICU_USE_TIM1               FALSE
#endif
/**
 * @brief   ICU driver enable switch.
 * @details If set to @p TRUE the support for ICU3 is included.
 */
#if !defined(SIMUL_ICU_USE_TIM3) || defined(__DOXYGEN__)
#define SIMUL_ICU_USE_TIM3               FALSE
#endif
/**
 * @brief   ICU driver enable switch.
 * @details If set to @p TRUE the support for ICU4 is included.
 */
#if !defined(SIMUL_ICU_USE_TIM4) || defined(__DOXYGEN__)
#define SIMUL_ICU_USE_TIM4               FALSE
#endif
/**
 * @brief   ICU driver enable switch.
 * @details If set to @p TRUE the support for ICU5 is included.
 */
#if !defined(SIMUL_ICU_USE_TIM5) || defined(__DOXYGEN__)
#define SIMUL_ICU_USE_TIM5               FALSE
#endif
/** @} */
...
#if SIMUL_ICU_USE_TIM1 && !defined(__DOXYGEN__)
extern ICUDriver ICUD1;
#endif
#if SIMUL_ICU_USE_TIM3 && !defined(__DOXYGEN__)
extern ICUDriver ICUD3;
#endif
#if SIMUL_ICU_USE_TIM4 && !defined(__DOXYGEN__)
extern ICUDriver ICUD4;
#endif
#if SIMUL_ICU_USE_TIM5 && !defined(__DOXYGEN__)
