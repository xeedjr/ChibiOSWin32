 ...
 * @brief   SIMUL/MEGA SERIAL subsystem low level driver header.
 *
 * @addtogroup SERIAL
 * @{
 */
 ...
 */
#if !defined(SIMUL_SERIAL_USE_USART0) || defined(__DOXYGEN__)
  #define SIMUL_SERIAL_USE_USART0              TRUE
#endif
 ...
 */
#if !defined(SIMUL_SERIAL_USE_USART1) || defined(__DOXYGEN__)
#define SIMUL_SERIAL_USE_USART1              TRUE
#endif
...
/**
 * @brief   SIMUL Serial Driver configuration structure.
