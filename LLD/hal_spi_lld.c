 ...
 * @brief   SIMUL/MEGA SPI subsystem low level driver source.
 *
 * @addtogroup SPI
 * @{
 */
 ...
 */
#if SIMUL_SPI_USE_SPI1 || defined(__DOXYGEN__)
SPIDriver SPID1;
#endif
 ...
 */
#if SIMUL_SPI_USE_16BIT_POLLED_EXCHANGE
...
#else /* SIMUL_SPI_USE_16BIT_POLLED_EXCHANGE */
...
#endif /* SIMUL_SPI_USE_16BIT_POLLED_EXCHANGE */
